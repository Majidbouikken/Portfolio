                ...
                <div className="flex flex-col items-start gap-4">
                    ...
                    <div className="flex flex-col items-start gap-4 w-full">
                        ...
                        {success && <div className="absolute flex flex-row gap-4 items-end">
                            ...
                            <img src={"/3d-icons/3d-success.png"} className="h-16 w-16" />
                        </div>}
                    </div>
                    ...
                    <div className="grid grid-flow-col justify-items-start grid-rows-4 md:grid-rows-2 gap-y-2 gap-x-8">
                        ...
                        <div className="grid-item flex flex-wrap gap-4">
                            ...
                            <a href="https://www.upwork.com/freelancers/~0177e23888de4f6747" target="_blank" className="h-12 w-12 fill-text-800 dark:fill-text-50 hover:fill-white p-2 hover:bg-upwork border-background-400/50 dark:border-background-600/50 hover:border-upwork dark:hover:border-upwork border-2 rounded-full"><IconUpwork /></a>
                            {/* <a href="https://www.instagram.com/maj.bba/" target="_blank" className="h-12 w-12 fill-text-800 dark:fill-text-50 hover:fill-white p-2 instagram-gradient border-background-400/50 dark:border-background-600/50 hover:border-instagram dark:hover:border-instagram border-2 rounded-full"><IconInstagram /></a> */}
...
query ($language: String!) {
  locales: allLocale(
    filter: { ns: { in: ["hire-me", "misc"] }, language: { eq: $language } }
  ) {
    edges {
      node {
        ns
